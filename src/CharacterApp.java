...
public class CharacterApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Race (human or elf): ");
        while (!userInput.hasNext("human") && !userInput.hasNext("elf")) {
            System.err.println("Invalid input, you need to type in human or elf.");
            userInput.nextLine();
        }
