...
public class GameService {
    ...
    public static final String WORD_FILE = "src/Project/Hangman/word.txt";

    public void start(int level) throws FileNotFoundException {
        ...
        if (level==0){
            ...
            numberOfChances=randomWord.length();
        }else {
            numberOfChances = 10;
        }
    ...
    private List<String> getTheWords() throws FileNotFoundException {
        ...
        File wordsFile = new File(WORD_FILE);
