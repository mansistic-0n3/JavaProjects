...
public class Planet {
    ...
    public String toString() {
        return "Planet " + name + " (Size: " + size + " and Temperature: "+ temperature+ "°C), is "+type+" in nature"+
                "\n Closest Star Distance: " + closestStarDistance +"\t\t Distance From Earth: " + distanceFromEarth +"\n";
    }
